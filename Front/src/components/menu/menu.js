  ...
  return (
    <div className='principal menu-background-imagem'>
      ...
      <div className='menu-botoes-principais espaco-entre'>
        ...
        <div className='menu-botao-principal-1 alinha-centro menu-botao-principal menu-box-sahedow negrito' onClick={() => { openModal(); setModal(1) }}>
          <p>BUSCAR LIVRO</p>
        </div>
        <div className='menu-botao-principal-2 alinha-centro menu-botao-principal menu-box-sahedow negrito' onClick={() => { openModal(); setModal(2) }}>
